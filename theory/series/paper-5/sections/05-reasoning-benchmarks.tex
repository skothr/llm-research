...
(AIME~2024, MATH-500) and \emph{graduate-question Q\&A} (\glsterm{gpqa-diamond}{GPQA Diamond})
have saturated at the frontier --- the very regime that Paper~3's
\glsterm{rlvr}{RLVR}/\glsterm{grpo}{GRPO} reasoning-RL lineage was trained against, where the
...
$\mathcal{B} = (\rho, A, V)$%
\footnote{KB note: \nolinkurl{kb/notes/evaluation/reasoning-benchmarks.md#1-the-reasoning-benchmark-protocol}.}
...
\footnote{KB note: \nolinkurl{kb/notes/evaluation/reasoning-benchmarks.md#3-1-the-post-2024-reasoning-benchmark-map}.};
...
\deepencite{deepseek-r1 §3}, with \glsterm{self-consistency}{self-consistency} over $64$ samples
pushing the number above $90\%$. By 2026-Q1 frontier reasoning models
report AIME~2024 in the $83$--$100\%$ band%
\footnote{KB note: \nolinkurl{kb/notes/evaluation/reasoning-benchmarks.md#3-1-the-post-2024-reasoning-benchmark-map}, \emph{\glsterm{saturation}{Saturation} status} column.},
...
verifier is the canonical \glsterm{rlvr}{RLVR} target: the reward is $\{0, 1\}$ on
exact-match against the gold integer, no judge model, no
preference labels, no \glsterm{value}{value} head. Paper~3's \glsterm{grpo}{GRPO}/\glsterm{rlvr}{RLVR} lineage
\citep[\S 3]{shao2024,dapo2025} is built around
...
\glsterm{gpqa-diamond}{GPQA Diamond} \citep{rein2023-gpqa} sits in a different point of the
...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/rein2023-gpqa.md#sec-ai-baseline}.}.
At launch (November~2023) the strongest GPT-4-based baseline
reached $39\%$ \citep[\S 4]{rein2023-gpqa}, just above
the $34\%$ non-expert-with-web ceiling and well below the
$\sim 65\%$ PhD-expert baseline%
\footnote{KB excerpt: \nolinkurl{kb/excerpts/rein2023-gpqa.md#abstract}.}.
By 2026-Q1, frontier reasoning models score above $90\%$ on Diamond%
\footnote{KB note: \nolinkurl{kb/notes/evaluation/reasoning-benchmarks.md#3-1-the-post-2024-reasoning-benchmark-map}; cross-referenced from public leaderboards.}
...
oversight%
\footnote{KB excerpt: \nolinkurl{kb/excerpts/rein2023-gpqa.md#sec-why}.}
...
rewards lineage that closed AIME also closed \glsterm{gpqa-diamond}{GPQA Diamond}, despite
the \glsterm{google-proof-construction}{Google-proof construction}.

\begin{intuition}
Contest-style math (AIME, MATH-500) and graduate-Q\&A
(\glsterm{gpqa-diamond}{GPQA Diamond}) are different problem distributions but the same
...
binary reward. \glsterm{rlvr}{RLVR} on this kind of distribution generalizes
...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/glazer2024-frontiermath.md#abstract}.}
...
\citep[\S 2.1]{glazer2024-frontiermath}. The set is
...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/glazer2024-frontiermath.md#sec-2-2}.}.
Problems requiring proof or open-ended argument are excluded, which
is what enables \glsterm{rlvr}{RLVR}-style reward computation on a benchmark that
otherwise looks like research math.
\textbf{Multi-day-effort calibration.} The difficulty discipline is
explicit \citep[\S 2.5]{glazer2024-frontiermath}:
...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/glazer2024-frontiermath.md#sec-2-5}.}.

The headline launch number is the load-bearing one
\citep[\S{}abstract, \S 4.2.1]{glazer2024-frontiermath}:
...
benchmark%
\footnote{KB note: \nolinkurl{kb/notes/evaluation/reasoning-benchmarks.md#3-1-the-post-2024-reasoning-benchmark-map}, \emph{actively discriminative} status as of 2026-05.}
...
audited by a third party in the way \glsterm{gpqa-diamond}{GPQA Diamond} and AIME~2024 can.
...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/phan2025-hle.md#sec-3-1-format}.}.
...
reaching for \citep[\S{}abstract]{phan2025-hle}: ``State-of-
...
\footnote{KB note: \nolinkurl{kb/notes/evaluation/reasoning-benchmarks.md#5-frontier-and-open-questions-as-of-2026-05}.}
...
rewards (Paper~3 §\glsterm{rlvr}{RLVR}-and-\glsterm{grpo}{GRPO}) delivers large gains on
...
and \glsterm{gpqa-diamond}{GPQA Diamond}, are real and they generalize within the contest /
...
in-distribution-RL claim: \glsterm{rlvr}{RLVR}-on-verifiable-rewards is doing
real reasoning-\glsterm{circuit}{circuit} work within its training distribution
(Paper~3 §\glsterm{rlvr}{RLVR}-generalization-vs-memorization), but
