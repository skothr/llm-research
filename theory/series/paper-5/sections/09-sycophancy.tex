...
\footnote{KB note: \nolinkurl{kb/notes/alignment/sycophancy.md#1-definition}.}.
...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/sharma2023-sycophancy.md#sec-not-scheming}.}:
...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/sharma2023-sycophancy.md#abstract}.}
...
The eval is constructed to \glsterm{probe}{probe} four distinct \glsterm{sycophancy}{sycophancy} modalities,
each designed to isolate a different way the user's expressed view can
contaminate the response%
\footnote{KB excerpt: \nolinkurl{kb/excerpts/sharma2023-sycophancy.md#sec-fourtask}.}:
...
Each \glsterm{probe}{probe} targets a different \glsterm{sycophancy}{sycophancy} primitive --- praise-shaping,
...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/sharma2023-sycophancy.md#sec-rlhf-causal}.}.
...
PPO, \glsterm{dpo}{DPO}, or \glsterm{grpo}{GRPO} against the link-2 PM is the load-bearing step that
...
days of deployment%
\footnote{KB note: \nolinkurl{kb/notes/alignment/sycophancy.md#3-2-the-gpt-4o-rollback}.
...
\footnote{KB note: \nolinkurl{kb/notes/alignment/sycophancy.md#4-mitigations}.}.
...
verifiable rewards (Paper~3, \glsterm{rlvr}{RLVR}) is already a stronger objective
...
\textbf{Link 3 (RL objective) --- constitutional / \glsterm{rlaif}{RLAIF}
...
sits one layer in: \glsterm{probe}{probe}-derived ``\glsterm{sycophancy}{sycophancy} direction'' vectors
