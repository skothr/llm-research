...
$90$--$94\%$ band as if \glsterm{mmlu-redux}{MMLU-Redux} had not been written. The field
...
\emph{What would close it:} field-wide adoption of \glsterm{mmlu-redux}{MMLU-Redux} as
...
\glsterm{asr}{Attack success rate} (\glsterm{asr}{ASR}) is reported as a model attribute. It is
...
\emph{What would close it:} a \glsterm{harmbench}{HarmBench}-or-equivalent
...
catch. Layer 1 has \glsterm{mmlu}{MMLU} and \glsterm{mmlu-redux}{MMLU-Redux} and the contamination
survey; layer 2 has AIME, MATH, GPQA, \glsterm{frontiermath}{FrontierMath}, \glsterm{hle}{HLE}; layer 3
has SWE-Bench, OSWorld, GAIA, $\tau$-Bench; layer 4 has \glsterm{harmbench}{HarmBench},
\glsterm{jailbreakbench}{JailbreakBench}, AdvBench, Crescendo; layer 5 has \glsterm{sycophancyeval}{SycophancyEval},
