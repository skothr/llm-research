...
static benchmark vs adversarial \glsterm{probe-2}{probe} vs deployment audit), tied
...
\begin{description}
  ...
  \item[Construct.] What latent property is the benchmark trying to
    ...
    solving; of \glsterm{harmbench-2}{HarmBench}, refusal-rate under attack; of Apollo's
...
not \citep[\S{}sec-cot]{wang2024-mmlu-pro}. The \glsterm{chain-of-thought}{CoT}-vs-direct gap
...
the score is \glsterm{attack-success-rate}{attack success rate} on a search-augmented set, not
...
$(\text{capability}, \text{knowledge}, \text{static})$; \glsterm{harmbench-2}{HarmBench} is
...
single number%
\footnote{KB excerpt: \nolinkurl{kb/excerpts/liang2022-helm.md#sec-metrics}.}.
...
\glsterm{harmbench-2}{HarmBench} \glsterm{asr}{ASR}. Per-axis breakdowns appear in tech reports
...
``\glsterm{asr}{ASR}'' number across \glsterm{harmbench-2}{HarmBench}, \glsterm{jailbreakbench-2}{JailbreakBench}, AdvBench is
