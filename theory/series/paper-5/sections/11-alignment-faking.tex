...
(\cref{sec:rlhf,sec:constitutional}). Apollo's scheming construct
...
form: the RL objective from \cref{sec:rlhf-ppo} is
...
is the natural Phase~2 follow-up. \cref{sec:probing-and-circuits} of
