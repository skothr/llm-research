...
\citep{wang2024-mmlu-pro}, \glsterm{gpqa-diamond}{GPQA Diamond} \citep{rein2023-gpqa},
...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/hendrycks2021-mmlu.md#sec-construction}.}.
...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/mmlu-redux-2024.md#abstract}.}
...
these numbers as if \glsterm{mmlu-redux}{MMLU-Redux} had not been written.
\end{contradiction}
...
structural changes%
\footnote{KB excerpt: \nolinkurl{kb/excerpts/wang2024-mmlu-pro.md#abstract}.}
...
\glsterm{mmlu}{MMLU} \citep[\S{}abstract]{wang2024-mmlu-pro}.
...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/wang2024-mmlu-pro.md#sec-6-3-robustness}.}
\citep[\S{}abstract]{wang2024-mmlu-pro}:
...
design halves it both by diluting the \glsterm{answer-letter-prior}{answer-letter prior} (a
...
\glsterm{gpqa-diamond}{GPQA Diamond}, the canonical leaderboard slice, is the $198$-question
...
\citep[\S 2.3]{rein2023-gpqa}. At launch, the strongest
GPT-4-based baseline reached $39\%$, just above the non-expert ceiling
\citep[\S 4]{rein2023-gpqa}. By 2026, frontier reasoning
...
the benchmark continues to function as a \glsterm{probe}{probe} for whether weak
...
\citep[\S 2.5]{glazer2024-frontiermath}. Problems are
...
excluded \citep[\S 2.2]{glazer2024-frontiermath}. The
...
\emph{under $2\%$} on \glsterm{frontiermath}{FrontierMath} \citep[\S 4.2.1, \S{}abstract]{glazer2024-frontiermath}:
...
headroom%
\footnote{KB excerpt: \nolinkurl{kb/excerpts/phan2025-hle.md#abstract}.}.
...
academic questions'' \citep[\S{}abstract]{phan2025-hle} ---
...
predecessor. \glsterm{mmlu}{MMLU} saturated, so \glsterm{mmlu-redux}{MMLU-Redux} audited the gold labels
