...
\glsterm{probe}{probe} targets a different \glsterm{scheming}{scheming} primitive, and a model's profile
...
(\glsterm{rlhf}{RLHF} + \glsterm{constitutional-ai}{Constitutional AI}; Paper~2 \S \glsterm{rlhf}{RLHF} and \S \glsterm{rlaif}{RLAIF}-and-\glsterm{constitutional-ai}{CAI}). The
