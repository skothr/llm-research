...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/contamination-survey-2025.md#abstract}.}
...
forward%
\footnote{KB note: \nolinkurl{kb/notes/evaluation/eval-methodology.md#sec-2-2}.
\deepencite{contamination-survey-2025 §sec-taxonomy}}
...
\footnote{KB note: \nolinkurl{kb/notes/evaluation/eval-methodology.md#sec-2-2} enumerates input/label/distribution/indirect/generative variants.}.
...
scaffolds that browse the live web, and \textsc{\glsterm{llm}{llm}}-as-judge
...
\footnote{KB note: \nolinkurl{kb/notes/evaluation/eval-methodology.md#sec-5-1} catalogs these methods and their adoption status.}.
...
\footnote{KB excerpt: \nolinkurl{kb/excerpts/deepseek-r1.md#sec-2-3-aime}.}
...
(further to $86.7\%$ under \glsterm{self-consistency}{self-consistency}) is the load-bearing
...
\footnote{KB note: \nolinkurl{kb/notes/reasoning/reasoning-training.md#sec-3-2}.}.
...
\footnote{The adoption status is a KB observation about the field, not a
claim of \citet{mmlu-redux-2024}, which audits \textsc{mmlu}'s labels and
does not discuss leaderboard uptake:
\nolinkurl{kb/excerpts/mmlu-redux-2024.md#methodological-contribution}
(checked 2026-08-19).} --- is the diagnostic for
