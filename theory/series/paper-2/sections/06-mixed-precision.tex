...
\nolinkurl{kb/excerpts/torchtitan2024.md#sec-2-2-4-fp8}.} The mixed-precision
...
\paragraph{Optimizer-precision coupling.} \glsterm{muon}{Muon}'s update RMS,
...
\texttt{\#sec-2-2-wd}.} The \glsterm{muon}{Muon}-Moonlight fix is mandatory weight
