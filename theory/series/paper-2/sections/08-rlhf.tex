...
\nolinkurl{kb/excerpts/ouyang2022-instructgpt.md#sec-3}.} The lineage
...
\nolinkurl{kb/excerpts/ouyang2022-instructgpt.md#sec-4}.} The headline
...
\cref{sec:rlhf-frontier} (\glsterm{dpo}{DPO} replacing PPO, \glsterm{rlaif}{RLAIF} / \glsterm{constitutional-ai}{CAI} replacing
human labels, \glsterm{grpo}{GRPO} replacing both for verifiable-reward reasoning)
...
\glsterm{dpo}{DPO} $\to$ \glsterm{rlvr}{RLVR} stack. The driver is infrastructural: PPO requires
...
the problem). \glsterm{grpo}{GRPO} \citep{shao2024} replaces the \glsterm{value}{value} model with a
group-mean baseline; \glsterm{dapo}{DAPO} \citep{dapo2025} adds asymmetric clipping
...
hacked. The contradiction is sharper than \glsterm{dpo}{DPO}-vs-PPO: \glsterm{rlaif}{RLAIF} and \glsterm{constitutional-ai}{CAI}
