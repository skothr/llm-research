...
\item[\cref{sec:frontier-snapshot} --- Frontier-2026 snapshot.] The
  six-stage table across the disclosed frontier (\glsterm{precision-pinning}{DeepSeek-V3} / R1,
  Llama 3 / 4, Qwen 2.5 / 3, Phi-4, T\"ulu 3, OLMo 2, \glsterm{mistral}{Mistral} Large,
