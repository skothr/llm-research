...
\nolinkurl{kb/excerpts/torchtitan2024.md#sec-1-axes}.} Each axis is a
...
excerpt: \nolinkurl{kb/excerpts/torchtitan2024.md#sec-2-1-1-meta}.} on
...
excerpt: \nolinkurl{kb/excerpts/torchtitan2024.md#sec-2-1-2-fsdp2}.}
...
\nolinkurl{kb/excerpts/torchtitan2024.md#sec-2-2-3-async-tp}.}
...
\nolinkurl{kb/excerpts/torchtitan2024.md#sec-2-1-5-cp}.}: ``on Llama 3.1
...
\begin{align}
\text{1F1B:}\;\;& (p-1)(F + B), \nonumber\\
\text{ZeroBubble (ZB1P):}\;\;& (p-1)(F + B - 2W), \nonumber\\
\text{DualPipe:}\;\;& \bigl(\tfrac{p}{2} - 1\bigr)(F\mathbin{\text{\&}}B + B - 3W),
\label{eq:bubble-formulas}
\end{align}
verbatim from \citet[\S 3.2.1, table]{deepseek-v3}\footnote{KB excerpt:
\nolinkurl{kb/excerpts/deepseek-v3-training.md#sec-3-2-1-bubble}.}, where
...
\nolinkurl{kb/excerpts/deepseek-v3-training.md#sec-3-2-1-dualpipe}.}, the
...
\toprule
Axis combination & Per-GPU param & Per-GPU optim & Per-GPU activ. & Per-step / per-layer comm \\
\midrule
...
\glsterm{expert-parallel}{EP} (size $e$)               & $P_{\text{shared}} + P_E E/e$ & matched & $\sim A$ + dispatch buf. & 2 all-to-alls / MoE layer \\
\bottomrule
\end{tabularx}
...
\nolinkurl{kb/excerpts/torchtitan2024.md#abstract}.} The components that
...
excerpt: \nolinkurl{kb/excerpts/torchtitan2024.md#sec-2-1-4-pp}.}
...
\citet[\S 1]{deepseek-v3}.\protect\footnotemark}
\label{tab:dsv3-cost}
\end{table}\footnotetext{KB excerpt:
\nolinkurl{kb/excerpts/deepseek-v3-training.md#sec-1-cost}.}

The parallelism plan is \citep[\S 3.2]{deepseek-v3}\footnote{KB
excerpt:
\nolinkurl{kb/excerpts/deepseek-v3-training.md#sec-3-2-parallelism}.}:
...
$(\tfrac{p}{2} - 1)(F\mathbin{\text{\&}}B + B - 3W)$ --- roughly half of 1F1B at the
...
\nolinkurl{kb/excerpts/deepseek-v3-training.md#sec-3-2-2-allreduce}.} A
...
Returning to canonical form: in \cref{eq:bubble-formulas}, $F\mathbin{\text{\&}}B$ is
...
\glsterm{muon}{Muon}} \citep[\S 2.3]{muon-moonlight2025}\footnote{KB excerpt:
\nolinkurl{kb/excerpts/muon-moonlight2025.md#sec-2-3-distributed}.}: a
sharded variant of the \glsterm{muon}{Muon} optimizer (\cref{sec:optimization})
compatible with ZeRO-1 \glsterm{data-parallel}{DP}. The wrinkle is that \glsterm{muon}{Muon}'s Newton-Schulz
...
Distributed \glsterm{muon}{Muon} (Moonlight) & 2025 & Per-rank Newton-Schulz on gathered grad & \citep[\S 2.3]{muon-moonlight2025} \\
\bottomrule
\end{tabularx}
...
\glsterm{muon}{Muon}'s full-matrix $\mathbf{O}_t$ exceeds BF16 high-precision range
