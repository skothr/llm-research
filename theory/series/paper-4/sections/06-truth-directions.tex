...
methodology this section assembles. Paper~5 §9 (\glsterm{sycophancy}{sycophancy}, written;
Paper~5 \S \glsterm{sycophancy}{sycophancy} when linked at compile) consumes the
\citeauthor{vennemeyer2025-sycophancy-not-one-thing} multi-component
result directly; Paper~5 §10 (\glsterm{scheming}{scheming}) and §11 (alignment-faking) use
