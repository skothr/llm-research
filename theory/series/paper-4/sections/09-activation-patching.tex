...
The lens and \glsterm{probe}{probe} of \S\ref{sec:logit-lens-family}--\S\ref{sec:probing}
...
high-accuracy \glsterm{probe}{probe} at layer $\ell$ is consistent with the property
...
\nolinkurl{kb/excerpts/meng2022-rome.md#sec-2}.}, restated by
\citet[\S 2.1]{zhang2023-apatching} as the now-standard
recipe\footnote{KB excerpt:
\nolinkurl{kb/excerpts/zhang2023-apatching.md#sec-2-1}.}. Fix a clean
...
\nolinkurl{kb/excerpts/meng2022-rome.md#sec-2-effects}.}:
\begin{equation}
...
\hat{\mathbf{d}}$ along a \glsterm{probe}{probe} direction $\hat{\mathbf{d}}$, leaving
the orthogonal complement unchanged --- the natural granularity for
``patch the \glsterm{truth-direction}{truth direction}'' or ``patch the Paris \glsterm{feature}{feature}.''
...
\nolinkurl{kb/excerpts/zhang2023-apatching.md#sec-2-1-metrics}.}.
...
\nolinkurl{kb/excerpts/heimersheim2024.md#sec-4-1}.}: it is a
...
\nolinkurl{kb/excerpts/heimersheim2024.md#sec-4-2}.}: probability is
...
\nolinkurl{kb/excerpts/wang2022-ioi.md#sec-3-circuit}.} push \emph{against}
...
\nolinkurl{kb/excerpts/zhang2023-apatching.md#sec-2-1-corruption}.}.
...
\nolinkurl{kb/excerpts/zhang2023-apatching.md#sec-findings}.} ---
...
\nolinkurl{kb/excerpts/heimersheim2024.md#sec-2-3}.}. The protocol
...
Subspace & $\mathbf{P}_{\hat{\mathbf{d}}}\,\mathbf{h}_i^{(\ell)}$ & \glsterm{probe}{probe}-direction patches \\
\bottomrule
\end{tabular}
...
finer-grained patching at the subspace level or a downstream \glsterm{probe}{probe}-on-%
...
\nolinkurl{kb/excerpts/wang2022-ioi.md#sec-3-1-path-patching}.} is the
...
\nolinkurl{kb/excerpts/zhang2023-apatching.md#sec-1}.} ---
...
\nolinkurl{kb/excerpts/heimersheim2024.md#sec-4-2}.} --- a patch that
...
\glsterm{activation-patching}{Activation patching} is the method that turns the lens-and-\glsterm{probe}{probe}
