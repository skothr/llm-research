...
On the intentionally-misaligned-model auditing game from
\citet{marks-tegmark-2023-truth}, \glsterm{natural-language-autoencoder}{NLA}-equipped auditing agents
