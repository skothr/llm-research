...
\nolinkurl{kb/excerpts/gao2024-topk-saes.md#sec-1-headline}.}. The headline
...
\nolinkurl{kb/excerpts/gao2024-topk-saes.md#sec-2-4}.}; the law is
...
\nolinkurl{kb/excerpts/gemma-scope-2024.md#sec-1}.}. The \glsterm{common-crawl}{CC}-BY-4.0 release
...
Four pipelines are in active use as of 2026, each anchored on one of
the methods above.
...
excerpt: \nolinkurl{kb/excerpts/gao2024-topk-saes.md#sec-1-headline}.}.
...
of the four. The tuned-lens benchmarks of
...
\paragraph{Anthropic --- NLAs in pre-deployment audit.}
A second Anthropic pipeline, distinct from the \glsterm{circuit}{circuit}-tracer line, is
the natural-language autoencoder (\glsterm{activation-verbalizer}{AV} + \glsterm{activation-reconstructor}{AR} pair) of
\citet{anthropic2026-nla}, used in the pre-deployment audit of \glsterm{claude}{Claude}
Opus 4.6 to surface unverbalized \glsterm{evaluation-awareness}{evaluation awareness} and
\glsterm{alignment-faking}{alignment-faking}-adjacent cognition. Output modality is free-form natural
language rather than \glsterm{logits}{logits} or sparse-\glsterm{feature}{feature} dictionaries; the
round-trip \glsterm{fraction-of-variance-explained}{FVE} score serves as a confabulation gate
(\S\ref{sec:nla}). No external reproduction as of 2026-Q2; the
methodology is reported only on the Anthropic-internal Opus 4.6 audit.
...
of the ten rows depend on tooling or claims that are HTML-only or
released-but-not-yet-reproduced; the remaining seven form a defensible
