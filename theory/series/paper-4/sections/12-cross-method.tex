...
divergence cases (\glsterm{truth-direction-2}{truth direction} across datasets; \glsterm{sparse-autoencoder}{SAE} \glsterm{feature}{feature}
...
\nolinkurl{kb/excerpts/wang2022-ioi.md#sec-2-task-and-circuit}.}. Three
...
\boldsymbol{\mu}_-$, is the canonical truth \glsterm{probe-2}{probe} of
...
The \glsterm{truth-direction-2}{truth direction} recovered from the \texttt{cities} dataset
(``The capital of France is Paris.'') and the \glsterm{truth-direction-2}{truth direction}
...
excerpt: \nolinkurl{kb/excerpts/templeton2024-scaling-monosemanticity.md#sec-4}
...
cosine between the \glsterm{probe-2}{probe} direction and the \glsterm{sparse-autoencoder}{SAE} \glsterm{feature}{feature} decoder
...
\begin{contradiction}
\textbf{There may not be a single \glsterm{truth-direction-2}{truth direction}.} Mass-mean
...
single-axis truth-\glsterm{probe-2}{probe} assumption may be the wrong shape of model
...
cross-model-family study reporting \glsterm{probe-2}{probe} direction, \glsterm{sparse-autoencoder}{SAE} \glsterm{feature}{feature}
direction, and patching-validated causal direction in matched
coordinates.
\end{contradiction}

This is principled divergence in part. A \glsterm{probe-2}{probe} asks ``what
...
load-bearing once the field makes single-axis truth-\glsterm{probe-2}{probe} claims
...
\glsterm{probe-2}{probe} direction'') is a claim about \emph{this} \glsterm{sparse-autoencoder}{SAE}'s inventory,
