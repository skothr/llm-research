...
architectural shifts complicate the picture. First, \glsterm{mla}{MLA}-compressed-KV
attention (the \glsterm{mla}{MLA} mechanism of \hyperref[P1-sec:attention-kv-sharing]{Paper~1 §5}; DeepSeek-V2/V3) and grouped-\glsterm{query}{query} attention (Llama 3 family)
...
the hypothesis survives the MoE / \glsterm{mla}{MLA} architectural shifts is open
empirical.
