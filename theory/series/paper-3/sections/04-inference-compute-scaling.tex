...
\footnote{KB excerpt: \texttt{kb/excerpts/snell2024.md\#sec-3-1}. Notation note: \citet{snell2024} write the subscript with mixed labels $a^\ast$ in the index and $y^\ast$ in the indicator; we unify to $y^\ast(q)$ throughout for readability without altering the equation's content.} as
\begin{equation}
...
\glsterm{chain-of-thought}{chain-of-thought} (\cref{sec:cot-phenomenon}), \glsterm{self-consistency-2}{self-consistency}
