...
\texttt{kb/excerpts/deepseek-r1.md\#sec-2}.} that the \glsterm{format-reward}{format reward} of
...
\texttt{kb/notes/post-training/\glsterm{capability-ceiling}{rlvr}-and-grpo.md\#2-3}.} R1's protocol
