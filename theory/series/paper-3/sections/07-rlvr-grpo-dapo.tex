...
treatment (Paper~2 §11, which covers \glsterm{grpo-2}{GRPO}/\glsterm{dapo-2}{DAPO} as one stage of the
...
of the same machinery (Paper~2 §11) treats \glsterm{rlvr-3}{RLVR} as the successor to
