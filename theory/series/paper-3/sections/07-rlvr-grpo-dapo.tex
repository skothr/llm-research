...
update on the better-than-$p_0(q)$ rollouts. RLVR cannot make the
policy solve a problem it has \emph{never} solved at any sample budget;
it can only sharpen the distribution toward the rollouts that already
succeed.
\end{intuition}
