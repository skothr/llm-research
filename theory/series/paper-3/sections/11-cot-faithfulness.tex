...
(\textbf{GPT-5.2, \glsterm{claude}{Claude} Opus 4.5, Gemini-3-flash-preview,
\glsterm{precision-pinning}{DeepSeek-v3}.2}) on $100$ GSM8K problems at varying \glsterm{self-consistency-2}{self-consistency}
...
\citep[abstract]{mehta2026-faithfulness-scaling}. The \glsterm{claude}{Claude} Opus 4.5
