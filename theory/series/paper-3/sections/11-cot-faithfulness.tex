...
\footnote{KB note:
\texttt{kb/notes/reasoning/\glsterm{chain-of-thought}{chain-of-thought}.md\#4}.} the trace $z$ is
...
\footnote{Excerpt status:
\texttt{kb/excerpts/arcuschin2025-\glsterm{chain-of-thought}{cot}-wild.md} is abstract-only as of
...
\footnote{KB note:
\texttt{kb/notes/reasoning/\glsterm{chain-of-thought}{chain-of-thought}.md\#4.1}.} The
...
\footnote{KB excerpt:
\texttt{kb/excerpts/deepseek-r1.md\#sec-2-3-aime}.} a correlation
...
\footnote{KB note:
\texttt{kb/notes/reasoning/\glsterm{chain-of-thought}{chain-of-thought}.md\#4.1}.} The reason
