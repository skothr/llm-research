...
inference-time compute (\cref{sec:inference-compute-scaling,
sec:self-consistency,sec:budget-forcing}), verifier signals
...
OpenAI o1 / o3
  ...
  & yes; proprietary RL on reasoning, ``the more reinforcement learning ($\ldots$) the more time it spends thinking'' \deepencite{openai-o1 — system card; cf.\ openai-o3 — system card}
