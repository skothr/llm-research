...
\citep[\S 3.2.2]{vaswani2017}. ``\glsterm{mha}{Multi-head attention} allows the
...
\glsterm{mha}{multi-head attention} in three places~\citep[\S
...
projections (\glsterm{mha}{MHA} $\to$ \glsterm{mqa}{MQA} $\to$ \glsterm{gqa}{GQA} $\to$ \glsterm{mla}{MLA}).
