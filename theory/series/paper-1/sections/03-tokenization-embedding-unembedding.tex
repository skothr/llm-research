...
\nolinkurl{kb/excerpts/sennrich2016.md#sec-3-2}.} from data compression
...
list is replayed deterministically over new text. Crucially, \glsdef{bpe}{BPE} is
...
\nolinkurl{kb/excerpts/kudo2018-sentencepiece.md#sec-3-1}.} Second, an
...
byte tokens, eliminating the UNK symbol entirely --- a later
\glsterm{sentencepiece}{SentencePiece} library \glsterm{feature}{feature} rather than a
contribution of the 2018 paper, which does not mention it.\footnote{KB
excerpt: \nolinkurl{kb/excerpts/kudo2018-sentencepiece.md#sec-byte-fallback};
arXiv:1808.06226 has five numbered sections (1 Introduction, 2 System
Overview, 3 Library Design, 4 Experiments, 5 Conclusions) and no
\glsterm{byte-fallback}{byte-fallback} discussion (checked 2026-08-19).} The three together
...
\nolinkurl{kb/excerpts/radford2019-gpt2.md#sec-2-2}.}:
...
\nolinkurl{kb/excerpts/press2017-tied-embed.md#sec-3-1}.} The forward path
...
\nolinkurl{kb/excerpts/blt2024.md#sec-2-3}.} Patch boundaries are placed
