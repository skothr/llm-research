...
ground-truth labels `[burns2023-w2s §3;
kb/excerpts/burns2023-w2s#sec-3-pgr]`. PGR = 0: matches supervisor;
...
`burns2023-w2s` `[burns2023-w2s §3;
kb/excerpts/burns2023-w2s#sec-3-setup]` finetunes large GPT-4-family
