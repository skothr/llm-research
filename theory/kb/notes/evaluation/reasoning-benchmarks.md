...
- **FrontierMath:** open-ended, with a single canonical numerical /
  symbolic answer parsed by a domain-specific checker `[glazer2024-frontiermath §2.2; kb/excerpts/glazer2024-frontiermath#sec-2-2]`.
...
`[rein2023-gpqa §2.3; kb/excerpts/rein2023-gpqa#sec-diamond]`.
...
`[glazer2024-frontiermath §2.2; kb/excerpts/glazer2024-frontiermath#sec-2-2]`.
...
`[glazer2024-frontiermath §4.2.1; kb/excerpts/glazer2024-frontiermath#sec-4-2-1]`.

The difficulty calibration:

> Solving a typical problem requires multiple hours of effort from a
> researcher in the relevant branch of mathematics, and for the upper end
...
key design rationale: FrontierMath is built for the post-saturation
regime — the paper itself claims only "a vast gap between AI
capabilities and the prowess of the mathematical community" and a
"rigorous testbed that quantifies their progress"
`[glazer2024-frontiermath §abstract; kb/excerpts/glazer2024-frontiermath#abstract]`;
reading that as a *response to* AIME saturation is this note's framing,
not the paper's.
...
`[wang2024-mmlu-pro §6.2; kb/excerpts/wang2024-mmlu-pro#sec-6-2-cot]`,
