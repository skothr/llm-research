...
`[jimenez2024-swebench §2.2; kb/excerpts/jimenez2024-swebench#sec-2-2-eval]`.
...
`[mialon2023-gaia §3; kb/excerpts/mialon2023-gaia#sec-3]`.
...
- A **per-task evaluator script** that checks the final OS state
  $s_T$ against the goal `[xie2024-osworld §2.2; kb/excerpts/xie2024-osworld#sec-2-2-3-1-env-design]`.
...
`[xie2024-osworld §4; kb/excerpts/xie2024-osworld#sec-4-results]`
...
`[yao2024-tau-bench §3; kb/excerpts/yao2024-tau-bench#sec-3-passk]`:
...
`[yao2024-tau-bench §5.1; kb/excerpts/yao2024-tau-bench#sec-5-1-results]`
