...
files in, and write the arc `README.md`. Findings that turn out to be dead
ends or pre-arc exploration go to `../archive/` instead.

Currently empty — the active investigations live under `../arcs/` and the
retired early probes under `../archive/`.
