...
A static-geometry arc probing the semantic and functional category
structure of Qwen2.5-7B-Instruct's input-embedding table (W_E), and how
the structural-token features it carries are used by the early layers.
...
moves to a new basis at L1), P1b/P1e/P3 not run (deferred, below).
Remaining follow-ups are recorded under [Possible next
paths](#possible-next-paths--deferred-at-the-2026-07-15-close-none-block-closure)
and are candidates for a successor arc rather than this one.
...
What semantic/functional category structure exists
...
## Findings — held as working hypotheses
...
## Possible next paths — deferred at the 2026-07-15 close; none block closure
