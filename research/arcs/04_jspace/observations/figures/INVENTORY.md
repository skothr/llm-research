...
| `2026-07-21-jspace-corpus-invariance.png` | `examples/jspace_render_corpus_invariance.py` | `data/structure_scan_qwen2.5-1.5b-instruct_jlens_*_n100{,_c4en}.pt`, `data/lens_eval_qwen2.5-1.5b_bf16_n100{,_c4en}.pt` | [§corpus-invariance](DATA_PROVENANCE.md#corpus-invariance) | committed (corpus check); re-rendered 2026-08-16 after its two `_c4en` inputs were regenerated on the redacted C4 corpus |
...
| `2026-09-23-jspace-paper-metric-matched-kd.png` | `examples/jspace_render_paper_metric_matched_kd.py` | `data/paper_metric_varfrac_qwen2.5-1.5b-instruct_jlens_qwen2.5-1.5b_bf16_n100{,_heldoutc4en}.pt`, `data/paper_metric_varfrac_qwen2.5-7b-instruct_jlens_qwen2.5-7b_nf4_n100{,_heldoutc4en,_heldoutc4en_k58,_refitlens_k25,_refitlens_k58}.pt` | [§paper-metric-matched-kd](DATA_PROVENANCE.md#paper-metric-matched-kd) | committed (issue #83 dimension-matched K) |
