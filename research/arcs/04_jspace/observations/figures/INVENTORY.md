...
| `2026-09-23-jspace-paper-metric-matched-kd.png` | `examples/jspace_render_paper_metric_matched_kd.py` | `data/paper_metric_varfrac_qwen2.5-{1.5b,7b}-instruct_jlens_*_n100{,_heldoutc4en}.pt`, `data/paper_metric_varfrac_...7b_nf4_n100_{heldoutc4en_k58,refitlens_k25,refitlens_k58}.pt` | [§paper-metric-matched-kd](DATA_PROVENANCE.md#paper-metric-matched-kd) | committed (issue #83 dimension-matched K) |
