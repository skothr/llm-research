...
def main() -> None:
    vocab_path = read_artifact("vocab_atlas.pt")
    print(f"loading vocab atlas from {vocab_path}")
    ...
    out = write_artifact("concept_arithmetic_atlas.pt")
    torch.save(
        {
            "combos": combos,
