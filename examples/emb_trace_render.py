...
def main() -> None:
    ...
    ax.set_xlabel("layer")
    ax.set_ylabel("block norm fraction of residual delta")
    ax.legend()
    ax.grid(alpha=0.3)
    ...
    ax.set_xlabel("layer")
    ax.set_ylabel("residual block norm fraction")
    ax.legend(fontsize=8)
    ax.grid(alpha=0.3)
    ax.set_title("P2: delimiter-specific block norm fraction collapses at layer 1")
