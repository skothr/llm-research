"""Dense interpolation near the t=0.421 pivot.
...
def main() -> None:
    source = read_artifact("interpolation_flipbook.pt")
    ...
    for i, t in enumerate(ts, 1):
        ...
        print(
            f"  [{i:>3}/{len(ts)}] t={t:.4f}  ({elapsed:.0f}s)  "
    ...
    out = write_artifact("dense_interp_near_pivot.pt")
    torch.save(
        {
