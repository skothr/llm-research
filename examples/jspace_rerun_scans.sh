...
# validation_max_vf_diff is 4.379e-01 by construction (an isolated-position
# outlier: max|diff| 4.379e-01 while the per-layer mean varfrac@25 agrees
# with the July artifact to 2.6e-3, so at most a few of the 270 positions per
# layer differ materially) — see the consistency report below.
